...
def find_best_match(user_input: str, question_list: list[str]) -> str | None:
    ...
    matches = get_close_matches(user_input_lower, question_list, n=1, cutoff=0.8)
...
def chat():
    knowledge_base = load_knowledge_base('convo.json')
            ...
            if tag:
                ...
                if response:
                    ...
                    if new_answer.lower() != 'skip' and new_answer:
                        ...
                        save_knowledge_base('convo.json', knowledge_base)
